  ...
  return (
    <div className="relative ">
      ...
      <div className="h-96 w-[40rem absolute mt-40 ml-9">
        <h1 className="text-[#DCBFFF]  w-[35rem] text-left text-2xl font-bold font-sans ">
        ...
        <button onClick={handleNavigate} className="border-2 mt-9 ml-40 focus-within:border-violet-400 rounded-2xl h-16 w-44 text-white text-lg font-mono hover:bg-gradient-to-br from-purple-900 via-fuchsia-400 to-violet-400">
          Get Started
        </button>
      </div>
    </div>
