...
const Middlebox = () =>{
  ...
  const circles = [
    ...
    return(
      <div className="mx-2 md:mx-4 lg:mx-6 xl:mx-8 my-6 h-60 rounded-lg overflow-hidden relative shadow-lg flex justify-center items-center">
        <div className="absolute inset-x-0 z-10 top-8 text-center text-2xl font-semibold text-gray-600">
        <span className="gradient-text">Discover Amazing Items</span>
              </div>
      ...
      <div className="absolute bottom-4 w-full flex justify-around">
        {circles.map((circle) =>(
          ...
          <p className="text-xs text-gray-600 mt-1">Text 1</p>
        </div>
        ))}
      </div>
      <div>
