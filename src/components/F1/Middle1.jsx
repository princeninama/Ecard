...
import Profile from "./Middle3.jsx";
import Message from "./Middle2.jsx";
...
const Home = () => {
  return (
    ...
    <Navbar/>
      ...
      <div
        className="bg-gradient-to-r from-red-50 to-red-200 w-[100%] mt-24 h-[60rem] relativer md:mt-96  lg:h-[65rem] lg:mt-[34rem] lg:pt-40"
        id="eventsSection"
      >
        ...
        <Profile />
        <div className="h-screen p-4  lg:p-52 pt-16 lg:pt-40 bg-black relative">
      <video
        src={vid}
        autoPlay
        muted
